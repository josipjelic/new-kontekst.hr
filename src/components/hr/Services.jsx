    ...
    <section id="usluge" className="services-section py-24 lg:py-32" aria-labelledby="usluge-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          <article className="service-card" {...cardTilt}>
            <div className="service-card-reveal reveal">
          ...
          <article className="service-card" {...cardTilt}>
            <div className="service-card-reveal reveal reveal-delay-1">
              <div className="service-icon" aria-hidden="true">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  <path
                    strokeLinecap="round"
          ...
          <article className="service-card" {...cardTilt}>
            <div className="service-card-reveal reveal reveal-delay-2">
              <div className="service-icon" aria-hidden="true">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  <path
                    strokeLinecap="round"
